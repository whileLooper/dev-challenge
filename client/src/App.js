        ...
        <div className="row">
          ...
          <div className="col-lg-8 col-sm-12">
            <h2 className="text-center">
              {this.state.detail ? this.state.detail['TitleName'] : ''}
              {this.state.detail ? (
                <span className="text-muted"> - { this.state.detail.ReleaseYear }</span>
              ) : (
                ''
              )}
            </h2>
            ...
            <div className="row">
              ...
              {this.state.detail
                ? this.state.detail.Awards.map(award => (
                    <div
                      className="col-lg-3 p-0 card border-info mb-3 mr-2"
                      style={{ maxWidth: '220px' }}
                    >
                      <div className="card-header">
                        {award.AwardCompany}{' '}
                        {award.AwardWon ? (
                          <span className="badge badge-danger">Won</span>
                        ) : (
                          ''
                        )}
                      </div>
                      ...
                      <p className="card-text">
                        {award.hasOwnProperty('Participants')
                          ? award.Participants.toString()
                          : ''}
                      </p>
                      <small className="card-text text-muted text-right">
                        - {award.AwardYear}
                      </small>
                    </div>
                  ))
